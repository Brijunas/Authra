...
description: "Testing conventions using xUnit v3, Testcontainers (PostgreSQL 18.1), Respawn for data reset, AwesomeAssertions, NSubstitute, and Bogus fixtures."
when_to_use: "When writing unit tests, integration tests, fixtures, or Respawn/Testcontainers setup code."
paths:
  - "tests/**/*.cs"
version: 2.2.0
---
