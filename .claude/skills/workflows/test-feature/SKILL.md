---
name: test-feature
description: Generate comprehensive test suite for a feature including unit and integration tests
---
...
| `authra-data-model` | Entity structure for fakers |
...
| Agent | Purpose |
|-------|---------|
| `test-engineer` | Generate all tests |
