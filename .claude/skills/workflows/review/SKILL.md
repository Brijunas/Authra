---
name: review
description: Comprehensive code review with architecture and convention validation
---
...
| Skill | Usage |
|-------|-------|
| `clean-architecture` | Layer boundaries, feature folders |
| `dotnet-conventions` | C# 14 standards |
