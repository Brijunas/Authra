...
description: Analyze performance including N+1 queries, indexes, caching, and async patterns
---
...
| Skill | Usage |
|-------|-------|
| `authra-data-model` | Entity relationships |
...
| Agent | Purpose |
|-------|---------|
| `performance-reviewer` | Primary analysis |
| `ef-core-specialist` | Query optimization |
