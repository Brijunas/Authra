...
description: Comprehensive security review of a feature, endpoint, or file
---
...
2. Review related convention skills (authra-security)
...
| Skill | Usage |
|-------|-------|
| `authra-security` | JWT, tokens, Argon2id, permissions |
| `api-conventions` | Validation patterns |
| `authra-data-model` | RLS enforcement |

## Agents to Invoke

| Agent | Purpose |
|-------|---------|
| `security-reviewer` | Primary security analysis |
