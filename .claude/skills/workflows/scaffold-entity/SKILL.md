...
description: Scaffold a complete entity with Domain model, EF Core configuration, and migration
---
...
- `authra-data-model` convention skill
- `dotnet-conventions` convention skill
- `clean-architecture` convention skill

## Convention Skills Applied

| Skill | Usage |
|-------|-------|
| `authra-data-model` | Entity patterns, UUID v7, RLS, relationships |
| `dotnet-conventions` | C# 14 coding standards, naming |
| `clean-architecture` | Domain layer placement |

## Agents to Invoke

| Agent | Purpose |
|-------|---------|
| `ef-core-specialist` | EF Core configuration, migration generation |
