...
description: "REST API patterns for Authra's Minimal API endpoints — URL structure, versioning, request/response shapes, validation, error handling, and pagination."
when_to_use: "When writing, editing, or reviewing REST endpoints, DTOs, validators, or error-response shapes in Authra's Minimal API layer."
paths:
