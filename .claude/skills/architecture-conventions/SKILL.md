...
description: "Clean Architecture layer boundaries and dependencies for Authra — Domain → Application → Infrastructure → Api, with feature folders and DI conventions."
when_to_use: "When creating new files in any `Authra.*` project — to enforce layer dependencies, feature folder layout, and DI boundaries."
paths:
  - "src/**/*.cs"
version: 2.2.0
---
