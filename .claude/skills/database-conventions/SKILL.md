...
description: "Persistence patterns for Authra's EF Core 10 + PostgreSQL 18.1 stack — UUID v7 primary keys with Medo.Uuid7, Row-Level Security, tenant-scoped tables, repository abstractions, migration policy, and Npgsql integration."
when_to_use: "When designing or modifying persistence code — entities, EF Core configurations, queries, repositories, migrations, or RLS policies."
paths:
